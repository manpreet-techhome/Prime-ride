...
const CarDetails = () => {
 ...
 <form onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 spac-y-6 text-gray-500'>
      ...
      <button className='w-full bg-primary hover:bg-primary-dull transition all py-3 font-medium text-white rounded-xl cursor-pointer mt-2'>Book Now</button>
      <p className='text-center text-sm mt-1'>No credit card required to reserve</p>
 </form>
 </div>
    </div>
  ) : <Loader/>
